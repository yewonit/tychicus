            ...
            <div class="d-flex align-center">
              ...
              >
                ...
                <span class="attendance-tooltip-content">
                  <strong>출석률 계산 방식:</strong>
                  <br />
                  • 기본적으로 각 예배는 주 1회 기준으로 계산됩니다.
                  <br />
                  • 주간: 해당 주차의 각 예배별 출석률
                  <br />
                  • 월간: 해당 월의 주간 출석률들의 평균
                  <br />
                  • 분기/연간: 각 주간의 출석률을 기간 내에서 평균
                  <br />
                  • 출석률 = (출석한 인원) / (전체 출석 대상자 수)
                  <br />
                  <i class="ml-2">
                    * 상단의 기간 선택에 따라 출석률 계산 방식이 변경됩니다
                  </i>
                </span>
              </v-tooltip>
            </div>
    ...
    methods: {
      ...
      renderAttendanceTrendChart() {
        ...
        this.trendData.forEach((item, index) => {
          const x =
            margin.left +
            (innerWidth * index) / (this.trendData.length - 1 || 1);
