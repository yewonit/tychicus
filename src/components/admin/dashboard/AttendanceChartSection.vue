        ...
        >
          <div class="d-flex flex-wrap justify-space-between">
            <v-tooltip bottom>
              ...
              <span>
                선택된 기간 동안의 모든 모임 출석률의 평균입니다.
                <br />
                전체 인원 대비 출석한 인원의 비율입니다.
              </span>
            </v-tooltip>
            ...
            <v-tooltip bottom>
              ...
              <span>
                <strong>{{ stats.maxAttendanceRate }}%</strong>
                - 선택된 기간 내 가장 높은 출석률을 기록한 날짜입니다.
                <br />
            ...
            <v-tooltip bottom>
              ...
              <span>
                <strong>{{ stats.minAttendanceRate }}%</strong>
                - 선택된 기간 내 가장 낮은 출석률을 기록한 날짜입니다.
                <br />
            ...
            <v-tooltip bottom>
              ...
              <span>
                선택된 기간 동안 모든 모임에 출석한 인원의 총합입니다.
                <br />
                한 사람이 여러 모임에 출석한 경우 중복 집계됩니다.
              </span>
            </v-tooltip>
  ...
  export default {
    ...
    computed: {
      ...
      filteredChartData() {
        ...
        const filteredTypes = filteredIndices.map(
          (i) => rawData.meetingTypes[i]
        );
      ...
      stats() {
        ...
        const avgAttendees = Math.round(
          totalAttendees / attendanceCounts.length
        );
    ...
    methods: {
      ...
      createChart() {
        ...
        try {
          ...
          // 차트 유형에 따른 데이터셋 설정
          const datasets = this.configureDatasetsByChartType(
            chartData.datasets
          );
                  ...
                  callbacks: {
                    title: (context) => {
                      ...
                      if (detailData) {
                        ...
                        const dayOfWeek = moment(detailData.date).format(
                          'dddd'
                        );
        ...
        try {
          ...
          if (
            ...
            this.chart.options.scales.y.max =
              Math.ceil(maxValue / 10) * 10 + 10; // 10 단위로 반올림하고 여유 추가
          }
