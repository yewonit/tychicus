  ...
  <v-container grid-list-xs class="mt-6 mb-16 pb-16">
    ...
    <v-row v-if="this.$vuetify.breakpoint.smAndDown" class="mx-1 text-center">
      <v-col class="mb-5" c cols="12" xl="6" lg="6" md="8" sm="12">
        <span class="wc-h2"> {{ workDetail.company_name }} </span><br />
        <span class="wc-st1"> {{ workDetail.work_description }} </span><br />
      </v-col>
    </v-row>
    <v-row>
      <v-spacer></v-spacer>
      <v-col cols="11">
        ...
        <v-row v-if="!this.$vuetify.breakpoint.smAndDown" class="mx-1">
          <v-col class="mb-5" cols="12" xl="3" lg="3" md="3" sm="12">
            <span class="wc-h4"> {{ workDetail.tel }} </span><br />
            <span class="wc-st1"> 대표전화 </span><br />
          </v-col>
          <v-col class="mb-5" cols="12" xl="5" lg="5" md="5" sm="12">
            ...
            ><br />
            <span class="wc-st1"> 산업 위치 </span><br />
          </v-col>
          <v-col class="mb-5 pl-5" cols="12" xl="4" lg="4" md="4" sm="12">
            <span class="wc-h4"> {{ workDetail.work_description }} </span><br />
            <span class="wc-st1"> 주요 업무소개 </span><br />
          </v-col>
        </v-row>
        ...
        <v-row class="mx-1 mt-16">
          <v-col class="mt-10 mb-10 text-center" cols="12">
            <span class="wc-h2"> 제품 & 포트폴리오 </span><br />
            <span class="wc-st1"> Portfolio </span><br />
          </v-col>
          <v-col
...
export default {
  ...
  methods: {
    ...
    async readData() {
      ...
      const tempWork = await this.openReadDataItemById(this.Work, this.workId);
      ...
      this.representativeImage = await this.readWorkFileList(tempWork.id, "WR");
      ...
      this.businessKeywordList = await this.openReadBusinessKeywordListByWorkId(
        tempWork.id
      );
      ...
      if (tempUser.authority_idx !== null && tempUser.authority_idx !== "") {
        ...
        this.lv1_Data("user_authority_idx", this.workDetail.user_authority_idx);
      }
      ...
      if (tempUser.phone_number !== null && tempUser.phone_number !== "") {
        this.$set(this.workDetail, "user_phone_number", tempUser.phone_number);
