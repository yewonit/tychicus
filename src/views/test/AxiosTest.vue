  ...
  export default {
    ...
    methods: {
      ...
      async testFile() {
        ...
        // CREAT DATA
        const authNewFile = await this.authCreateData(
          this.File,
          this.modelFile
        );
        console.log(`%c[ Data ] authNewFile`, 'color: #E3DAC9;', authNewFile);

        const openNewFile = await this.openCreateData(
          this.File,
          this.modelFile
        );
      ...
      async testUser() {
        ...
        // CREAT DATA
        const authNewUser = await this.authCreateData(
          this.User,
          this.modelUser
        );
        console.log(`%c[ Data ] authNewUser`, 'color: #E3DAC9;', authNewUser);

        const openNewUser = await this.openCreateData(
          this.User,
          this.modelUser
        );
      ...
      async testUHFile() {
        ...
        const authReadUHFileListByUserId =
          await this.authReadUHFileListByUserId(0);
        console.log(
          `%c[ Data ] authReadUHFileListByUserId`,
          'color: #E3DAC9;',
          authReadUHFileListByUserId
        );
        const openReadUHFileListByUserId =
          await this.openReadUHFileListByUserId(1);
        console.log(
          `%c[ Data ] openReadUHFileListByUserId`,
          'color: #E3DAC9;',
          openReadUHFileListByUserId
        );
        const authReadUHFileListByFileId =
          await this.authReadUHFileListByFileId(0);
        console.log(
          `%c[ Data ] authReadUHFileListByFileId`,
          'color: #E3DAC9;',
          authReadUHFileListByFileId
        );
        const openReadUHFileListByFileId =
          await this.openReadUHFileListByFileId(0);
        console.log(
      ...
      async testWork() {
        ...
        // CREAT DATA
        const authNewWork = await this.authCreateData(
          this.Work,
          this.modelWork
        );
        console.log(`%c[ Data ] authNewWork`, 'color: #E3DAC9;', authNewWork);
        const openNewWork = await this.openCreateData(
          this.Work,
          this.modelWork
        );
      ...
      async testWHFile() {
        ...
        const authReadWHFileListByWorkId =
          await this.authReadWHFileListByWorkId(
            this.WHFile,
        ...
        const authReadWHFileListByFileId =
          await this.authReadWHFileListByFileId(
            this.WHFile,
        ...
        const openReadWHFileListByWorkId =
          await this.openReadWHFileListByWorkId(
            this.WHFile,
        ...
        const openReadWHFileListByFileId =
          await this.openReadWHFileListByFileId(
            this.WHFile,
      ...
      async testBNHFile() {
        ...
        const authBNHFileItemByFileId = await this.authReadBNHFileListByFileId(
          0
        );
        console.log(
        ...
        const openBNHFileItemByFileId = await this.openReadBNHFileListByFileId(
          0
        );
        console.log(
      ...
      async testFileCRUD_userProfile() {
        ...
        // CREAT DATA
        console.log(
          `%c[ View: AxiosTest ] CREAT User Profile`,
          `color:#BFFF00;`
        );
        ...
        // READ DATA
        console.log(
          `%c[ View: AxiosTest ] READ User Profile`,
          `color:#BFFF00;`
        );
      ...
      async testFileCRUD_workRefImg() {
        ...
        // UPDATE DATA
        console.log(
          `%c[ View: AxiosTest ] UPDATE workRefImg`,
          `color:#BFFF00;`
        );
        const updatedFile = await this.updateFile(
          workRefImg.id,
        ...
        // DELETE DATA
        console.log(
          `%c[ View: AxiosTest ] DELETE WorkRefImg`,
          `color:#BFFF00;`
        );
      ...
      async testFileCRUD_workPortfolio() {
        ...
        console.log(
          `%c[ Data ] workPortfolio`,
          'color: #E3DAC9;',
          workPortfolio
        );
        // READ DATA
        console.log(
          `%c[ View: AxiosTest ] READ workPortfolio`,
          `color:#BFFF00;`
        );
      ...
      async testFileCRUD_biznewsRef() {
        ...
        // UPDATE DATA
        console.log(
          `%c[ View: AxiosTest ] UPDATE biznewsRef`,
          `color:#BFFF00;`
        );
        const updatedFile = await this.updateFile(
          biznewsRef.id,
        ...
        // DELETE DATA
        console.log(
          `%c[ View: AxiosTest ] DELETE biznewsRef`,
          `color:#BFFF00;`
        );
